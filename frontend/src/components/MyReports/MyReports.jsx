 ...
 * MyReports.jsx
 * ------------------------------------------------
 * קומפוננטה להצגת כל הדיווחים של המשתמש
 *
 * תכונות:
 * - שליפת הדיווחים מהשרת
 * - הצגת הדיווחים בטבלה
 * - הצגת תמונה של הדיווח
 * - לחיצה על תמונה פותחת תצוגה גדולה
 * - אפשרות ביטול דיווח (רק אם הסטטוס "חדש")
 * - חלון אישור לפני ביטול
 */
